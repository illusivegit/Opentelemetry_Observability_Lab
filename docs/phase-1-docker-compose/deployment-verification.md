...
Common verification problems now live in [troubleshooting/common-verification-issues.md](troubleshooting/common-verification-issues.md). Use that guide for detailed symptoms, diagnostic commands, and fixes for backend health checks, Nginx DNS, Grafana data gaps, and DB latency panels.
...
- **Nginx Proxy Pass Options:** See `docs/phase-1-docker-compose/troubleshooting/nginx-proxy-pass-options.md` for detailed explanation of Option 1 vs Option 2
